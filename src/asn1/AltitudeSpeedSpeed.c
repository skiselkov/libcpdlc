...
static asn_SET_OF_specifics_t asn_SPC_speed_seqOf_specs_3 = {
	sizeof(struct AltitudeSpeedSpeed__speed_seqOf),
	offsetof(struct AltitudeSpeedSpeed__speed_seqOf, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_AltitudeSpeedSpeed_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct AltitudeSpeedSpeed, altitude),
		-1 /* Ambiguous tag (CHOICE?) */,
		0,
		&asn_DEF_Altitude,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct AltitudeSpeedSpeed, speed_seqOf),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
static const ber_tlv_tag_t asn_DEF_AltitudeSpeedSpeed_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_AltitudeSpeedSpeed_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_AltitudeSpeedSpeed_specs_1 = {
	sizeof(struct AltitudeSpeedSpeed),
	offsetof(struct AltitudeSpeedSpeed, _asn_ctx),
	asn_MAP_AltitudeSpeedSpeed_tag2el_1,
	9,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_AltitudeSpeedSpeed = {
	"AltitudeSpeedSpeed",
	"AltitudeSpeedSpeed",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_AltitudeSpeedSpeed_tags_1,
	sizeof(asn_DEF_AltitudeSpeedSpeed_tags_1)
		/sizeof(asn_DEF_AltitudeSpeedSpeed_tags_1[0]), /* 1 */
	asn_DEF_AltitudeSpeedSpeed_tags_1,	/* Same as above */
	sizeof(asn_DEF_AltitudeSpeedSpeed_tags_1)
		/sizeof(asn_DEF_AltitudeSpeedSpeed_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_AltitudeSpeedSpeed_1,
	2,	/* Elements count */
	&asn_SPC_AltitudeSpeedSpeed_specs_1	/* Additional specs */
};
