...
static asn_SET_OF_specifics_t asn_SPC_time_seqOf_specs_3 = {
	sizeof(struct PositionTimeTime__time_seqOf),
	offsetof(struct PositionTimeTime__time_seqOf, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_PositionTimeTime_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PositionTimeTime, position),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PositionTimeTime, time_seqOf),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
static const ber_tlv_tag_t asn_DEF_PositionTimeTime_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PositionTimeTime_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_PositionTimeTime_specs_1 = {
	sizeof(struct PositionTimeTime),
	offsetof(struct PositionTimeTime, _asn_ctx),
	asn_MAP_PositionTimeTime_tag2el_1,
	6,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_PositionTimeTime = {
	"PositionTimeTime",
	"PositionTimeTime",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_PositionTimeTime_tags_1,
	sizeof(asn_DEF_PositionTimeTime_tags_1)
		/sizeof(asn_DEF_PositionTimeTime_tags_1[0]), /* 1 */
	asn_DEF_PositionTimeTime_tags_1,	/* Same as above */
	sizeof(asn_DEF_PositionTimeTime_tags_1)
		/sizeof(asn_DEF_PositionTimeTime_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_PositionTimeTime_1,
	2,	/* Elements count */
	&asn_SPC_PositionTimeTime_specs_1	/* Additional specs */
};
